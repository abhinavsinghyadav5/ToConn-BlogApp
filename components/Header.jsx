  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        <h1 className='text-3xl sm:text-5xl font-medium'>Explore Blogs</h1>
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>"Welcome to ToConn Blogs explore Tech Insights,Lifestyle and much more. Learn about Industry, startups and Health." </p>
